...
export function findById14(http: HttpClient, rootUrl: string, params: FindById14$Params, context?: HttpContext): Observable<StrictHttpResponse<AutorisationSortieDto>> {
...
findById14.PATH = '/AutorisationS/{id}';
