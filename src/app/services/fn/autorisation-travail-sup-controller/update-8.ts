...
export function update8(http: HttpClient, rootUrl: string, params: Update8$Params, context?: HttpContext): Observable<StrictHttpResponse<AutorisationTravailSupDto>> {
